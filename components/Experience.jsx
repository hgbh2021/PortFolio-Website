...
import Textures from "../public/pexels-designecologist-1779487.jpg";
import PIN from "../public/pexels-luis-gomes-546819.jpg";
    ...
    <div className=" mt-32 lg:mt-8 flex flex-col justify-start space-y-12 mx-auto items-center md:mt-20 lg:min-h-screen">
      ...
      <div className="w-[80%] mx-auto">
        <div className="text-center max-w-2xl mx-auto tracking-normal leading-5 text-base sm:text-[1.1rem] lg:text-lg">
          During these {new Date().getUTCFullYear() - 2020} years of Computer science engineering, I have developed a strong problem-solving and
          critical thinking skills, and am able to quickly adapt to new
          technologies and methods of working. I have learned a lot of skills and knowledge in the past 3 years. I have mastered the programming languages C++ and Python, which are widely used for developing software applications and data analysis. I have also explored the emerging field of blockchain, which is a decentralized and secure way of storing and transferring data. I have also studied data structures and algorithms, which are the fundamental concepts and tools for designing efficient and elegant solutions to computational problems.
        </div>
      ...
      <div className="flex flex-col relative space-y-16 md:space-y-10 lg:space-y-8 items-center">
        ...
        <div className="drop-shadow-2xl flex flex-col space-y-4 mx-6 md:mx-20 lg:mx-0 md:w-[70%] lg:w-[80%] max-w-2xl rounded-[1.4rem] p-4 rounded-tl-none md:rounded-tr-none lg:rounded-tl-[2rem] hover:bg-gradient-to-tr hover:from-[#ffeff7] hover:to-[#F0F6FE] transition ease-in-out duration-500 hover:shadow-xl transform hover:-translate-x-2  bg-gradient-to-tr from-[#ffeff7] to-[#F0F6FE] dark:from-gray-900 dark:to-gray-600 dark:hover:bg-gradient-to-tr dark:hover:from-gray-900 dark:hover:to-gray-600 lg:bg-none">
          ...
          <div className="font-normal sm:text-[0.95rem] md:text-base text-center">
            ...
            skills mainly in NextJs and TailwindCSS. Made responsive websites as my internship task While working at GrowthCraft
          </div>
        ...
        <div className="drop-shadow-xl flex flex-col space-y-4 mx-6 md:mx-20 lg:mx-0 md:w-[70%] lg:w-[80%] max-w-2xl rounded-[1.4rem] p-4 rounded-tl-none hover:bg-gradient-to-tr hover:from-[#ffeff7] hover:to-[#F0F6FE] transition ease-in-out duration-500 hover:shadow-xl transform hover:translate-x-2 bg-gradient-to-tr from-[#ffeff7] to-[#F0F6FE] dark:from-gray-900 dark:to-gray-600 dark:hover:bg-gradient-to-tr dark:hover:from-gray-900 dark:hover:to-gray-600 lg:bg-none">
          ...
          <div className="font-normal sm:text-[0.95rem] md:text-base text-center">
          During my B.Tech degree, I learned C++, Python and data structures and algorithms, which are important for programming and software development.  Programming is the skill of creating instructions for computers to solve problems. I have good knowledge and skills in
          </div>
      ...
      <div className="w-[80%] max-w-2xl mx-auto">
        <div className="text-center font-normal mb-6 tracking-normal text-sm leading-5 sm:text-base lg:text-lg ">
          Apart from these I have gained knowledge in Database Management, Computer Networks, Machine Learning, NodeJS, GitHub, and MERN stack.
        </div>
        <div className="flex justify-center space-x-3 md:space-x-6 lg:space-x-8 items-center  my-4">
          <div className="group border-purple-400 hover:bg-purple-400 hover:text-white hover:drop-shadow-2xl text-purple-500 rounded-md md:rounded-xl px-2 py-1 md:px-4 md:py-2 shadow-md drop-shadow-lg dark:bg-purple-400 dark:shadow-none dark:hover:shadow-white select-none dark:text-white shadow-purple-300 ">
            <Link
              href="/Hemant_gaur.pdf"
              target="_blank"
          ...
          <div className=" group border-blue-400 hover:bg-blue-400 text-blue-500 hover:text-white hover:drop-shadow-2xl rounded-md md:rounded-xl px-2 py-1 md:px-4 md:py-2 shadow-md drop-shadow-lg dark:bg-blue-400 dark:shadow-none dark:hover:shadow-white select-none dark:text-white shadow-blue-300">
            <Link
              href="https://github.com/hgbh2021?tab=repositories"
              className="flex items-center font-normal lg:font-bold space-x-2 text-sm md:text-base  "
            >
